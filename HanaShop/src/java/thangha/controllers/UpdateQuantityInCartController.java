...
public class UpdateQuantityInCartController extends HttpServlet {
    ...
    private final static Logger LOGGER = Logger.getLogger(UpdateQuantityInCartController.class.getName());
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            boolean result = cart.updateQuantity(dto);
            if (result) {
                session.setAttribute("CART", cart);
            }

        } catch (Exception e) {
            LOGGER.error("Error at UpdateQuantityInCartController: " + e.toString());
        } finally {
