...
public class PaginationController extends HttpServlet {
    private final static Logger LOGGER = Logger.getLogger(PaginationController.class.getName());
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<FoodAndDrinkDTO> list = foodAndDrinkDAO.getListFoodAndDrinkForUser(search, priceFrom, priceTo, category, pageID, total);

            int numberOfArticles = foodAndDrinkDAO.getNumberOfFoodAndDrinkForUser(search, priceFrom, priceTo, category);
            ...
            LOGGER.error("Error at PaginationController: " + e.toString());
        } finally {
