 ...
 * @author Admin
 */
public class AdminSearchInvoiceHistoryController extends HttpServlet {
    private final static Logger LOGGER = Logger.getLogger(AdminSearchInvoiceHistoryController.class.getName());

    private final String SUCCESS = "admin_invoice_history.jsp";
    /**
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<Integer> listInvoiceHistoryID = invoiceDAO.getListInvoiceHistoryIDForAdmin(foodName, dayFrom, dayTo);
