...
public class FilterDispatcher implements Filter {
    private final static Logger LOGGER = Logger.getLogger(FilterDispatcher.class.getName());

    private static final boolean debug = true;
    private final String INDEX = "IndexController";
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        try {
            ...
            LOGGER.error("Error at FilterDispatcher: " + e.toString());
        }
    }
