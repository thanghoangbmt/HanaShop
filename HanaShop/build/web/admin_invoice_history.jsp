...
<html>
    <head>
        ...
        <title>Admin Invoice History</title>
        <style>
            body {
                background: #eecda3;
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="advanced-search-form">
                                    ...
                                    <!-- Search Form -->
                                    <form action="AdminSearchInvoiceHistory" method="POST" name="searchForm">
                                    ...
                                    <table class="table">
                                        <thead>
                                            <tr>
                                                ...
                                                <th scope="col" class="border-0 bg-light">
                                                    <div class="py-2 text-uppercase">Buyer Email</div>
                                                </th>
                                            ...
                                            <c:forEach var="listInvoice" varStatus="counter" items="${requestScope.LIST_INVOICE}">
                                                <tr>
                                                    ...
                                                    <td class="border-0 align-middle">
                                                        <strong>${listInvoice.buyerEmail}</strong>
                                                    </td>
